...
thickness_fp_prefix = ('/workspace/IceThickness/composite_thickness_RGI60-all_regions/')
# dem_farinotti_fp = ('/workspace/IceThickness/surface_DEMs_RGI60/' +
#                     'surface_DEMs_RGI60-01/')
dem_farinotti_fp_prefix = '/workspace/IceThickness/surface_DEMs_RGI60/'
output_fp = '/workspace/IceThickness/output/'
...
rgi_regionsO1 = [13]                 # RGI Order 1 regions
