...
#%% REMOVE POOR OBSERVATIONS AND FILL MISSING MB DATA WITH REGIONAL MEAN AND STD（去除不良观测值，用区域平均值和标准差填充缺失的MB数据）
...
if args.option_unh_climatedata == 1:
    climate_fp_hist = main_directory + '/workspace/Climate_data/UNH_cmip5/'
